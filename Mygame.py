...
gametitle="Journey - an interactive story game"
system("mode 110,30")
...
cls()
print("Journey - an interactive story game")

def Intro():
    print("")
    print("In this adventure, you are the hero.")
    print("Your choices, skills, and a bit of lucky, will influence the outcome of the game.")
    print("")
...
def skill_check():
    ...
    if roll+character_dexterity > 10:
        print ("""
            You dodge stone and survival Danger is not over though..
